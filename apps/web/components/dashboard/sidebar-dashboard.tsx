    ...
    const menuGroups = [
        {
            ...
            items: [
                ...
                { icon: Users, label: "Contactos", href: "/dashboard/contactos", badge: summary?.totalContacts ?? null },
                { icon: MessageCircle, label: "WhatsApp", href: "/dashboard/whatsapp", badge: null },
                { icon: Mail, label: "Email", href: "/dashboard/email", badge: null },
                { icon: CheckSquare, label: "Tareas", href: "/dashboard/tareas", badge: summary?.pendingTasks ?? null },
            ],
        },
        {
            title: "AUTOMATIZACIÓN",
            items: [
                { icon: FileText, label: "Plantillas WA", href: "/dashboard/plantillas", badge: null },
